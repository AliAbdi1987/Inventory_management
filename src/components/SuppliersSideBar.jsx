        ...
        <div className="relative flex flex-col items-center h-full">
          ...
          <ul className="space-y-3 my-3 flex-1">
            ...
            <li className="flex items-start">
                <a className="text-white bg-gray-700 text-sm flex items-center rounded pr-[121px] pl-2 py-3 w-full text-center">
                  <svg
            ...
            <li className="flex items-start">
              <Link to="/business/sales">
                <a
                  href="#"
                  className="text-white text-sm flex items-center hover:bg-gray-700 rounded pr-[145px] pl-2 py-3 transition-all cursor-pointer w-full text-center"
                >
                  <svg
